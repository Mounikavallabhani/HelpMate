...
public class CustomAdapterMade extends RecyclerView.Adapter<CustomAdapterMade.ViewHolder> {
    private ArrayList<PersonMade> mPersonList;
    ...
    public void add(int position, PersonMade item) {
    ...
    public CustomAdapterMade(ArrayList<PersonMade> personList, Context context) {
    ...
    @Override
    public CustomAdapterMade.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                       int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_row, parent, false);
        // set the view's size, margins, paddings and layout parameters
        CustomAdapterMade.ViewHolder vh = new CustomAdapterMade.ViewHolder(v);
        return vh;
    }
    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(CustomAdapterMade.ViewHolder holder, int position) {
